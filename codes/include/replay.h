...
ssize_t send_msg(
    Dev *dev, Net *net, Esp *esp, Txp *txp, char *str
);

bool dissect_rx_data(
    Dev *dev, Net *net, Esp *esp, Txp *txp,
    int *state, char *victim_ip, char *server_ip, bool *test_for_dissect
);
...
void get_info(
    Dev *dev, Net *net, Esp *esp, Txp *txp,
    int *try, char *victim_ip, char *server_ip, bool *test_for_dissect
);
